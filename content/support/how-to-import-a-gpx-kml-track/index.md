...
**On Android**, tap on the received GPX/KML file and the _Open with_ dialog will open up. You can then open the file with CoMaps, either as a 'one-off' or set Android to permanently open GPX/KML files with CoMaps. 
