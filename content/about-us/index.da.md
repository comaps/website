---
description: "Fri og åben navigation med privatlivsbeskyttelse -<br/>Bygget af fællesskabet"
extra:
  about:
  ...
  history:
    items:
      - text: "Navigationsappen MapsWithMe oprettes (senere omdøbt til Maps.me)."
        year: 2011
      - text: "Maps.me gjorde kildekoden tilgængelig under Apache 2.0-licensen."
        year: 2015
      - text: "Organic Maps-projektet og -virksomheden blev grundlagt på basis af Maps.Me-kildekoden."
        year: 2021
      - text: "Governance-spørgsmål og bekymringer fra fællesskabet, som ikke blev adresseret af virksomhedens aktionærer, forsinkede udviklingen af Organic Maps i flere måneder."
        year: 2025
      - highlight: true
        text: "**CoMaps**-fællesskabet og non-profit-projektet blev grundlagt af tidligere bidragydere til Organic Maps på basis af Organic Maps' kildekode."
        year: 2025
    title: Historie
  media_highlights:
  ...
  vm:
    items:
      - icon: /images/icons/about/mission.svg
        ...
        text: "Få friheden til nemt at navigere offline med privatlivsfokuserede kort til bilister, vandrere og cyklister, drevet af fællesskabet."
        title: Mission
      - icon: /images/icons/about/vision.svg
        media: /images/about-us/vision.png
        text: "Skab en verden, hvor navigation med kort er gratis, og hvor privatlivets fred som standard er det foretrukne valg på kloden."
        title: Vision
