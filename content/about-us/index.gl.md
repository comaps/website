...
extra:
  about:
    ...
    text: "CoMaps é unha aplicación para navegación por mapas centrada na privacidade, para viaxar, conducir, camiñar ou desprazamentos en bicicleta. Ofrece navegación con privacidade, sen identificar a persoas nen recoller datos. CoMaps funciona perfectamente sen precisar conexión a internet, para poder navegar en zonas urbanas ou lugares distantes, onde a conexión do móbil non está dispoñible. CoMaps é un proxecto de código aberto, que prioriza o desenvolvemento por parte da comunidade."
  ...
  data:
    ...
    text: "CoMaps é posible grazas ao traballo das comunidades que axudan a crear e manter os datos abertos que alimentan a nosa aplicación: os nosos mapas usan datos de OpenStreetMap, creados e mantidos por milleiros de colaboradores de todo o mundo. Para enlazar e ofrecer información sen conexión sobre cidades, atraccións e moitos outros puntos de interese, apoiámonos nos artigos e nas fotos das comunidades globais de Wikipedia, Wikidata e Wikimedia Commons."
    title: "Impulsado por datos abertos comúns"
  data_link:
