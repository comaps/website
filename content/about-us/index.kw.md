---
description: "Navigacyon rydh hag ygor gans privetter -<br/>Byldya gans an gemeneth"
extra:
  about:
  ...
  history:
    items:
      - text: "App navigacyon MapsWithMe gwrys (dashenwelys diwettha dhe Vaps.me)."
        year: 2011
      - text: "Maps.me ygerys an kod yn leshyans Apache 2.0."
        year: 2015
      - text: "An ragdres ha kompani Organic Maps o selys, selys war'n kod Maps.Me."
        year: 2021
      - text: "Kudynnow governieth ha bernyow kemeneth ny kewsel orth gans kevranoryon hedhys an displegyans dres misyow."
        year: 2025
      - highlight: true
        text: "An gemeneth **CoMaps** & ragdres heb budh o selys gans kevrisi kyns Organic Maps, selys war'n kod Organic Maps."
        year: 2025
    title: Istori
  media_highlights:
  ...
  vm:
    items:
      - icon: /images/icons/about/mission.svg
        ...
        text: "Dialhwedha an rydhses rag viajya dhywarlinen yn es, gans mappys privedh rag lewyoryon, kerdhoryon, ha diwrosyoryon, selys war'n gemeneth."
        title: Medras
      - icon: /images/icons/about/vision.svg
        media: /images/about-us/vision.png
        text: "Gul bys le may viajya gans mappys yw rydh, ha privetter yn defowt yw an penndewis war'n nor."
        title: Gwel
