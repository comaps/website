---
description: "Navigasi gratis dan terbuka yang menjaga privasi -<br/>Dibangun oleh komunitas"
extra:
  about:
  ...
  history:
    items:
      - text: "Aplikasi navigasi MapsWithMe dibuat (kemudian berganti nama menjadi Maps.me)."
        year: 2011
      - text: "Maps.me menjadikan kode sumber terbuka dengan lisensi Apache 2.0."
        year: 2015
      - text: "Proyek & perusahaan Organic Maps didirikan, berdasarkan kode sumber Maps.Me."
        year: 2021
      - text: "Masalah tata kelola dan kekhawatiran komunitas yang tidak ditanggapi oleh pemegang saham perusahaan menghambat pengembangan Organic Maps selama berbulan-bulan."
        year: 2025
      - highlight: true
    ...
    title: Sejarah
  media_highlights:
    description: "Lihat daftar lengkap liputan media tentang CoMaps."
    title: "Sorotan Media"
  vm:
    items:
      - icon: /images/icons/about/mission.svg
        media: /images/about-us/mission.png
        text: "Mewujudkan kebebasan navigasi offline yang mudah, dengan peta yang menjaga privasi bagi pengemudi, pendaki, dan pesepeda, serta didukung oleh komunitas."
        title: Misi
      - icon: /images/icons/about/vision.svg
        media: /images/about-us/vision.png
        text: "Menciptakan dunia di mana navigasi peta tersedia gratis, dan privasi sebagai standar menjadi pilihan utama di muka bumi."
        title: Visi
