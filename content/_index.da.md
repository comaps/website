...
extra:
  freedom:
    ...
    title: 'Nu er der frihed'
  map:
    description: 'Fællesskab + Åbne kort'
  services:
    items:
      - 
      ...
      - 
        ...
        title: 'Ingen dataindsamling'
      - 
        description: 'Bruger batteriet effektivt og dræner ikke dit batteri ligesom andre navigationsapps.'
        highlight:
          icon: static/images/icons/home/battery.svg
          text: 'Effektiv batterianvendelse'
        media:
          map: /images/sections/map-s-3.webp
          user: /images/sections/map-m-3.webp
        title: 'Spar på batteriet'
      - 
        cta:
          href: community/
          text: inv_title
