...
extra:
  ...
  services:
    items:
      ...
      - 
        description: 'Такие люди, как вы, помогли создать приложение, добавив местоположения в <span class="text-icon"><svg viewBox="0 0 19 19"><use href="#icon-open-street-map"></use></svg> [OpenStreetMap](https://openstreetmap.org)</span>, оставив отзыв о функциях и внеся код в <span class="text-icon"><svg viewbox="0 0 4.233 4.233"> <use href="#icon-codeberg"></use></svg> [Codeberg](https://codeberg.org/comaps)</span> в сообществе с открытым исходным кодом.'
        highlight:
