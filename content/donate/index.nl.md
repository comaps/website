...
extra:
  ...
  funding:
    items:
      ...
      - media: /images/donate/infrastructure.webp
        text: "We hebben snelle servers nodig, zodat iedereen ter wereld zonder vertragingen gratis updates van kaarten kan downloaden. Deze overdrachten vormen elke maand grote en groeiende hoeveelheden gegevens."
  ...
  info:
    - icon: static/images/icons/donate/icon01.svg
      text: "Wij zijn afhankelijk van jouw donaties om CoMaps open en gratis te houden"
    - icon: static/images/icons/donate/icon02.svg
      text: "Wij zijn een paar enthousiastelingen die bijdragen in hun vrije tijd. We houden van wat we doen en van onze gebruikers"
