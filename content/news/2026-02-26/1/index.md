---
title: "This couple is traveling the world with CoMaps"
description: "Javi and Rebecca are traveling the world as bikepackers. So far they've been through more than 15 countries, and they're still going!"
date: 2026-02-26T09:00:00-00:00
slug: "couple-traveling-the-world-with-comaps"
taxonomies:
    category: ["Blog"]
extra:
    author: "IXVG47QZ"
    author_username: "IXVG47QZ"
    keywords: ["traveling the world", "navigation app", "battery saving", "bikepacker", "bicycle", "cycling"]
---
...
- Instead of using navigation mode while bikepacking, Javi likes to follow a track manually, which he says saves his battery. ("But if I am in a big city where I need to reach a certain destination, then I use the voice instructions as well &lsqb;as navigation&rsqb; so I don't have to look at the screen.")
...
built. While other navigation apps have map coverage in many places, OpenStreetMap is often the most accurate in remote places. Because CoMaps uses offline map data from OpenStreetMap, they have been able to travel farther, safer. If you've ever added or corrected OpenStreetMap data in Europe, Asia, or Oceania, you might have helped him along the way!
