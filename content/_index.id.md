...
extra:
  freedom:
    ...
    title: 'Kebebasan Ada di Sini'
  map:
    description: 'Komunitas + Peta Terbuka'
  services:
    items:
      - 
      ...
      - 
        description: 'Menggunakan daya secara efisien, tidak menguras baterai seperti aplikasi navigasi lainnya.'
        highlight:
